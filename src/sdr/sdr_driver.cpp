...
void CSDRDriver::startStreaming()
{
    ...
    try
    {
        ...
        setStatus(ENUM_STATE::STREAMING);

        // number of complete reading.
        long int count=1;
        ...
        {	
            ...
            while(rec > 0){
                ...
                buffs[0] = out;
                numElems = rec;
                if(numElems > (uint)m_max_tx_unit) numElems=(uint) m_max_tx_unit;
            ...
            // TODO: you need to know who asked for this data.
